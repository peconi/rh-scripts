...
sits behind Cloudflare: the `__cflb` origin and the anycast colo. NEITHER
applies to `sequencer.mainnet.chain.robinhood.com`, which is plain EC2 in
us-east-2 with no CDN in front of it. So the question has to be
